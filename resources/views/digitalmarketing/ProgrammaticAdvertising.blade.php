...
<script>
    ...
    <nav class="breadcrumb">
        <a href="{{ route('digitalmarketing') }}"><i class="fas fa-home"></i></a>
        <span>/</span>
    ...
    <section class="home">
        <div class="home-content">
            <h1>Explore Your Paid Social Media Marketing Worker</h1>
            <p>Turn your business into a successful business through digital !</p>
        </div>
