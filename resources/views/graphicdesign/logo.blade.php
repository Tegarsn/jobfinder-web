...
<script>
    ...
    <nav class="breadcrumb">
        <a href="../graphic_design.html"><i class="fas fa-home"></i></a>
        <span>/</span>
    ...
    <section class="home">
        <div class="home-content">
            <h1>Explore Your Logo and Brand Design Worker</h1>
    ...
    <div class="card-container">
        ...
        <div class="card">
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('Viewjasalogo', $getjasa->id) }}">Detail</a>
            </div>
            <div class="card-footer">
            <p>{{ $getjasa->user_name }}</p>
            </div>
        </div>
        @endforeach
    </div>
