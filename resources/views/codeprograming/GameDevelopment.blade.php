...
<script>
    ...
    <nav class="breadcrumb">
        <a href="{{ route('codeprograming') }}"><i class="fas fa-home"></i></a>
        <span>/</span>
        <a href="{{ route('codeprograming') }}">Code Programming</a>
    </nav>

    <!-- Home Section -->
    <section class="home">
        <div class="home-content">
            <h1>Explore Your Game Development Worker</h1>
            <p>Make your Game Windows Or Handphone More Engaging and Interactive !</p>
        </div>
