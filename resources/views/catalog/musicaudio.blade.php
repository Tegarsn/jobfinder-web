...
<head>
    ...
    <link rel="stylesheet" href=" {{ asset ('frontend/css/music_audio.css') }}">
</head>
...
<script>
    ...
    <section class="home">
        <div class="home-img">
            <img src=" {{ asset ('frontend/img/Banner.png') }}" alt="home">
        </div>
    </section>
    ...
    <section class="categories">
        ...
        <a href="{{ route('graphicdesign') }}" class="category-item">
            ...
            <a href="{{ route('videoanimation') }}" class="category-item"><span class="material-icons-outlined">videocam</span>
                Video & Animation</a>
            <a href="{{ route('musicaudio')}}" class="category-item active"><span class="material-icons-outlined">audiotrack</span>
                Music & Audio</a>
    ...
    <section class="graphic-design-section">
        <h2>Explore Your Music & Audio</h2>
        <div class="design-container">
            <a href="catalog 5/songwritters.html" class="design-item">
                <img src="{{ asset ('frontend/images/musicaudio/songwriter.jpg') }}" alt="Song Writers">
                <h3>Songwriters</h3>
            </a>
            <a href="catalog 5/singer.html" class="design-item">
                <img src="{{ asset ('frontend/images/musicaudio/singer.jpg') }}" alt="Singer & Vocalist">
                <h3>Singer & Vocalist</h3>
            </a>
            <a href="catalog 5/audio.html" class="design-item">
                <img src="{{ asset ('frontend/images/musicaudio/tuning.jpg') }}" alt="Audio Tuning">
                <h3>Audio Tuning</h3>
            </a>
            <a href="catalog 5/voice_over.html" class="design-item">
                <img src="{{ asset ('frontend/images/musicaudio/voiceover.jpg') }}" alt="Voice Over">
                <h3>Voice Over</h3>
            </a>
            <a href="catalog 5/remix.html" class="design-item">
                <img src="{{ asset ('frontend/images/musicaudio/mixing.jpg') }}" alt="Mixing & Mastering">
                <h3>Mixing & Mastering</h3>
            </a>
            <a href="catalog 5/remix.html" class="design-item">
                <img src="{{ asset ('frontend/images/musicaudio/soundesign.jpg') }}" alt="Sound Design">
                <h3>Sound Design</h3>
            </a>
            <a href="catalog 5/remix.html" class="design-item">
                <img src="{{ asset ('frontend/images/musicaudio/production.jpg') }}" alt="Production Music">
                <h3>Production Music</h3>
            </a>
            <a href="catalog 5/remix.html" class="design-item">
                <img src="{{ asset ('frontend/images/musicaudio/editingaudio.jpg') }}" alt="Editing Audio">
                <h3>Editing Audio </h3>
            </a>
            </div>
        </div>
